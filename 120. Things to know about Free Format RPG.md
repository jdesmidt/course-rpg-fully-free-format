...
A full, classic fixed-format example (primary file, `L1`/`L2` control levels) is worked out in [examples/rpg-logic-cycle.md](examples/rpg-logic-cycle.md), as an illustration.
